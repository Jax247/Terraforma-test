...
export const ICONS = {
  ...
  close: X,
  info: Info,
  // The board's per-piece action menu: the button that opens it, and the two
  // chevrons that walk into and back out of a sub-page.
  actions: Ellipsis,
  back: ChevronLeft,
  ...
  defending: Shield,
  move: Footprints,
  // Shares Zap with `stunned` — same drawing, and the two never sit together.
  ability: Zap,
  flip: RefreshCw,
  shoot: Crosshair,
  target: Target,
